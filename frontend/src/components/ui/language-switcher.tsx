  ...
  return (
    ...
    >
      <SelectTrigger
        ...
        className="language-switcher-trigger relative z-20 h-8 w-10 shrink-0 justify-center rounded-md border border-border bg-background px-0 text-xs font-semibold text-foreground [&>svg]:hidden"
      >
        {current.short}
      </SelectTrigger>
      <SelectContent
