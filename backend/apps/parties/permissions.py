# apps/parties/permissions.py
"""
Parties Permissions.

Custom permission classes for the Parties domain.
"""
...
class CanManageParty(RoleBasedAccessPermission):
    """
    Permission to manage party records.
    ...
    message = _("Insufficient permissions to manage parties.")
